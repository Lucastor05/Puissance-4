        ...
        <div class="BarGame">
            <div class="dropDown-buttonStart">
                ...
                <div class="dropdown">
                    ...
                    <a onclick="themeButton(2);">A définir</a>
                    <a onclick="themeButton(3);">A définir</a>
                    </div>
                </div>
...
const budapest = "Theme_1/budapest.jpg",
                ...
                function StartGame(){
                    if(theme === 0 || difficulty === ""){
                        ...
                        const chrono = setInterval(timer, 10);


                        function memory(arr_difficulte, maxCompteur, chrono){
                        ...
                        //genere les images
                        if(theme === 1){
                            memory(config_cards_Facile_Capital, 16, chrono)
                        }else if(theme === 2){
                            memory(config_cards_Intermediaire_Capital, 32, chrono)
                        }else if(theme === 3){
        ...
        <script>
            const Bouton = document.querySelector('.buttonOpen > img');
            const chat = document.querySelector('.contentChat');
